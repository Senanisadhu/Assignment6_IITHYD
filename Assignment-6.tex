...
\begin{center}
	\begin{tikzpicture}
		...
		\node (B) at (0.6,4.29)[point,label=above right:$B$] {};
		\node (D) at (4.9,4.29)[point,label=above right:$D$] {};
		\node (O) at (2.4,2.1)[point,label=below:$O$] {};
		%Foot of perpendicular
...
\begin{figure}[htp]
	\centering
	\includegraphics[width=10cm]{new.png}
	\caption{Fig generated using python}
\end{figure}
\end{document}